signsight: clear main.o ImagePipeline.o
	...
	g++ main.o ImagePipeline.o -L../opencv/tbb/install/lib -I../opencv/tbb/install/include/opencv2 -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs -fopenmp -lpthread -o example
